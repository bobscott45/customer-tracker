    ...
    <div class="content">
        ...
        <form:form method="post" modelAttribute="customer" action="add">
            ...
            <div class="field">
                ...
                <div class="control">
                    <form:input path="email" class="input"></form:input>
                </div>
            </div>
            <div class="field">
                <div class="control">
                    <form:button class="is-primary">Submit</form:button>
                </div>
            </div>
        </form:form>

        <div>
            <p><a href="${pageContext.request.contextPath}/customer/list" class="button">Back to list</a></p>
        </div>
    </div>
</section>
</body>
